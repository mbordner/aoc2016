...
func main() {
	...
	o0, o1, o2 := GetChipReceiver(OUTPUT, ChipReceiverID(0)).(*chipOutput),
		GetChipReceiver(OUTPUT, ChipReceiverID(1)).(*chipOutput),
		GetChipReceiver(OUTPUT, ChipReceiverID(2)).(*chipOutput)

	fmt.Printf("outputs: %v, %v, %v\n", o0.chips, o1.chips, o2.chips)

	fmt.Println(o0.chips[0].val * o1.chips[0].val * o2.chips[0].val)
}
...
func (mc *MicroChip) String() string {
	return fmt.Sprintf("%d", mc.val)
}
